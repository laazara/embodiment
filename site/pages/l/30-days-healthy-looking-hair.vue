<template>
  <div>
    <div class=" bg-active bg-layout-m">
    ...
    <div class="pl2 pr2">
      <div class="maxw-xsuper dark ml-au mr-au">
        <div class="bwl4 bca-layout bsa-solid pl1 pl2-m">
          ...
          <h2 class="fs-1 lh0 fs2-m lh3-m fw3 maxw-super">A 3 step service using natural, organic and cold-pressed oils
            for maximum
            hair enrichment</h2>
        </div>
      </div>
    ...
    <div class="pl2 pr2">
      <div class="maxw-xsuper ml-au mr-au s-article">
        <p>We're not developing a new hair oil blend, we're tailor making blends
          that achieve the healthiest head of hair uniquely for you.
        </p>

        <div class="pa1 pa2-m bg-activel pb0 mb2">
          <h2 class="">No commitment. Join our waiting list to access the deal.</h2>
          <ul>
            <li>A limited tailored service to find the perfect organic oil blend that makes your hair its healthiest.</li>
            <li><strong>3 courses</strong> of 2x 100ml oil blends sent to your door over 3-12 months.</li>
            <li>A <strong>bonus</strong> course of 2x 100ml oil blends to keep you going for longer.</li>
            <li>A <strong>bonus</strong> of one 300ml organic natural shampoo.</li>
          </ul>
